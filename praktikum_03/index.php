...
<body>
   <div class="container mt-5">
    ...
    <div class="form-group row">
        ...
        <span id="fullnameHelpBlock" class="form-text text-muted">isi nama lengkap kamuu</span>
        </div>
    </div>
    <div class="form-group row">
        <label for="email" class="col-4 col-form-label">Email</label> 
        <div class="col-8">
        <input id="email" name="email" type="text" aria-describedby="emailHelpBlock" required="required" class="form-control"> 
